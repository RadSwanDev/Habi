...
export default function RegisterPage(){
    ...
    <h1 className='text-3xl font-bold text-lime-900 my-4'>Register</h1>
    ...
    <button onClick={registerAccount} className='bg-lime-500 p-2 text-white border-2 w-32 my-1 border-lime-500 rounded-md shadow-sm hover:border-lime-600 hover:shadow-md hover:text-lime-700 hover:cursor-pointer'>register</button>
